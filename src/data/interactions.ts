...
export const caseStudies: CaseStudy[] = [
  ...
  { id: "games", title: "小游戏", description: "把一个轻量想法快速变成可玩的互动体验。", url: "./cases/catch-the-line-game/", links: [{ label: "点击查看", url: "./cases/catch-the-line-game/" }, { label: "查看 Showcase", url: "https://yonge6.github.io/xiazi-echo-realm-showcase/" }] },
